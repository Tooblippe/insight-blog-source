...
# Title menu options
MENUITEMS = [('Archives', 'insightstack-blog/archives.html'),
             ('Home Page', 'http://www.insightstack.co.za')]
NEWEST_FIRST_ARCHIVES = False

#Github include settings
#GITHUB_USER = 'tooblippe'
#GITHUB_REPO_COUNT = 0
...
# Sharing
TWITTER_USER = 'tooblippe'
GOOGLE_PLUS_USER = 'TobieNortje'
